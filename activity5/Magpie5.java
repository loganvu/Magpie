...
public class Magpie5
{
    ...
    public String getResponse(String statement)
    {
        ...
        {
            response = "I am a retired professional quarterback for the New Orleans Saints";
        }
        else if (findKeyword(statement, "married") >=0)
        {
            response = "I am married to Brittany Brees";
        }    
        else if (findKeyword(statement, "children") >=0
        || findKeyword(statement, "kids") >=0)
        {            
            response = "I have four children.";
        } 
        else if (findKeyword(statement, "live") >=0)
        {
            response = "I currently live in uptown New Orleans with my wife and kids.";
        }
        else if (findKeyword(statement, "born") >=0)
        {
            response = "I was born in Dallas Texas.";
        }
        else if (findKeyword(statement, "names") >=0)
        {
            response = "Their names are Rylen, Bowen, Baylen, and Callen";
        }
